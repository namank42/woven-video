...
python3 .claude/skills/fetch-woven-analytics/scripts/analytics.py            # overall + per-user table
python3 .claude/skills/fetch-woven-analytics/scripts/analytics.py --user rfro  # + chronological timeline
python3 .claude/skills/fetch-woven-analytics/scripts/analytics.py --json      # raw aggregated JSON
```
